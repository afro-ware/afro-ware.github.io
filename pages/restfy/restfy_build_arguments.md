...
permalink: restfy_build_arguments.html
folder: mydoc
---
...
My preference is to add the scripts to profiles in iTerm. See [iTerm Profiles][restfy_iterm_profiles] for more details.
