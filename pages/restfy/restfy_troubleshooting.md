...
permalink: restfy_troubleshooting.html
folder: mydoc
---
...
If you run into permissions errors trying to run a shell script file (such as restfy_multibuild_web.sh), you may need to change the file permissions to make the sh file executable. Browse to the directory containing the shell script and run the following:
